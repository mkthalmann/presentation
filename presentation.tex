...
\begin{center}\includegraphics[width=0.9\linewidth]{figs/unnamed-chunk-4-1} \end{center}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# read chunk (does not run code)}
\KeywordTok{library}\NormalTok{(knitr)}
\KeywordTok{read\_chunk}\NormalTok{(}\StringTok{"setup.R"}\NormalTok{)}
