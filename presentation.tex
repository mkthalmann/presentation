...
\StringTok{    }\KeywordTok{stat\_summary}\NormalTok{(}\DataTypeTok{fun =}\NormalTok{ mean, }\DataTypeTok{geom =} \StringTok{"line"}\NormalTok{, }\DataTypeTok{color =}\NormalTok{ mygreen)}
\NormalTok{diamonds}\OperatorTok{$}\NormalTok{id \textless{}{-}}\StringTok{ }\DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(diamonds}\OperatorTok{$}\NormalTok{carat)}

\NormalTok{fit \textless{}{-}}\StringTok{ }\KeywordTok{aov\_ez}\NormalTok{(}\StringTok{"id"}\NormalTok{, }\StringTok{"price"}\NormalTok{, }\DataTypeTok{between =} \KeywordTok{c}\NormalTok{(}\StringTok{"color"}\NormalTok{, }\StringTok{"cut"}\NormalTok{), }\DataTypeTok{data =}\NormalTok{ diamonds)}
\KeywordTok{apa\_table}\NormalTok{(}
    \KeywordTok{apa\_print}\NormalTok{(fit)}\OperatorTok{$}\NormalTok{table,}
    \DataTypeTok{format =} \StringTok{"latex"}\NormalTok{,}
    \DataTypeTok{caption =} \StringTok{"Test Table"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\end{frame}
